...
{
    public class Fallout3Factory : IComponentFactory
    {
        private Fallout3Component _instance;
        ...
        {
            get { return "Automates splitting and load removal for Fallout 3."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            if (_instance != null && !_instance.Disposed)
            {
                ...
                MessageBox.Show(
                    "LiveSplit.Fallout3 is already loaded in the " +
            ...
            return (_instance = new Fallout3Component(state, createAsLayoutComponent));
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/drtchops/LiveSplit.Fallout3/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.Fallout3.xml"; }
        }
    }
